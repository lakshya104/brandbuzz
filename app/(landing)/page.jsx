...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 w-full">
      <div className="max-w-[988px] mx-auto w-full flex flex-col-reverse lg:flex-row items-center justify-around p-6 gap-8 bg-gradient-to-r from-cyan-50 to-sky-50 rounded-lg shadow-xl my-12">
      ...
      <div className="max-w-[988px] mx-auto flex-1 w-full flex flex-col lg:flex-row items-center justify-center p-6 gap-4 bg-gradient-to-r from-cyan-50 to-blue-100 rounded-lg shadow-lg my-12">
        <div className="relative w-[240px] h-[240px] lg:w-[424px] lg:h-[424px] mb-8 lg:mb-0">
          <Image src="/hero2.svg" fill alt="Hero" />
        </div>
        <div className="flex flex-col items-center gap-y-6">
          <h1 className="text-2xl lg:text-4xl font-extrabold text-neutral-700 max-w-2xl text-center">
